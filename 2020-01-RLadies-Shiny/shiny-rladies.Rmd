...
* We're going to focus on the New Sout Wales in south east Australia
* Today's fire location data from NSW Rural Fire Service
...
```
1. Code available at [github.com/AmandaRP/RLadiesBmoreShinyWorkshop](github.com/AmandaRP/RLadiesBmoreShinyWorkshop) (you can fork this repo or just copy and paste the code)
2. You'll need the wildfires.R script in this directory
...
4. Next move to the app.R file in the shinyDashboard folder
    - Try running the app.
    - Copy and paste components of the shiny app from #3 into this shiny dashboard app.
